...
const Roles = ({ isHorizontal }) => (
  <Segment.Group id="about" horizontal={isHorizontal} columns={3} className={rolesStyles.group}>
    <Segment textAlign='center' className={rolesStyles.dev}>
    ...
    <Segment textAlign='center' className={rolesStyles.speaking}>
      <Icon name='microphone' size='huge' style={{color: "white"}}/>
      <h2>Public Speaker</h2>
      <p>Our stories should be shared with the future generation. My story is unique and relateable to many.</p>
      <h3>Audiences</h3>
      <List>
    ...
    <Segment textAlign='center' className={rolesStyles.leader}>
